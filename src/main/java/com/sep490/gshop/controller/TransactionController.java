...
public class TransactionController {
    ...
    public ResponseEntity<Page<TransactionDTO>> getAllTransactions(@RequestParam(value = "page", defaultValue = "0") int page,
    ...
    public ResponseEntity<Page<TransactionDTO>> getTransactionsByCurrentUser(@RequestParam(value = "page", defaultValue = "0") int page,
                                                                             @RequestParam(value = "size", defaultValue = "10") int size,
                                                                             @RequestParam Sort.Direction direction) {
