...
public class PurchaseRequestServiceImpl implements PurchaseRequestService {
    ...
    public PurchaseRequestModel getPurchaseRequestById(String id) {
        try {
            ...
            log.debug("getPurchaseRequestById() end | groups: {}, subRequests: {}",
                    requestItemsGroupByPlatform.size(), subRequestModels.size());
            return response;
        } catch (Exception e) {
    ...
    public MessageResponse requestCorrection(UUID purchaseRequestId, String correctionNote) {
        ...
        try {
            ...
            String editUrl = redirectDomain + "/account-center/purchase-request/" + purchaseRequestId + "/edit";
