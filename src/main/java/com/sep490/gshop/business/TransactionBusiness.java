...
public interface TransactionBusiness extends BaseBusiness<Transaction>{
    ...
    Page<Transaction> findTransactionsByCustomerId(UUID customerId, long from, long to, TransactionType type, TransactionStatus status, Pageable pageable);
    ...
    Page<Transaction> findAllBetweenDatesAndFilterStatus(TransactionType type, TransactionStatus status,  Long startDate, Long endDate, Pageable pageable);
}
